...
import { projects, type CategoryType } from "./data"
...
const Projects: React.FC = () => {
  ...
  return (
    <S.Container id="portfolio">
      <S.AnimatedSection ref={sectionRef} className={isVisible ? "visible" : ""}>
        ...
        <S.ProjectsGrid>
          {displayedProjects.map((project) => (
            <ProjectCard key={project.id} {...project} isVisible={isVisible} />
          ))}
        </S.ProjectsGrid>
        {hasMoreProjects && (
